...
import com.mopanc.SantanderdevWeek.ui.MainViewModel
import com.mopanc.santanderdevweek.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindOnView(conta : Conta) {
        ...
        findViewById<TextView>(R.id.tv_card_final_value).text = conta.cartao.numeroCartao
    }
